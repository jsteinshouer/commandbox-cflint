...
component singleton="true" {
	...
	public any function init(){
		variables.OSGiUtil = createObject(
			"java",
	...
	public void function installBundle( required string bundleFile ){
		var CFMLEngineFactoryStatic = createObject(
			"java",
	...
	public void function removeBundle(
	...
	public boolean function isBundleInstalled(
		required string bundleName,
		required string bundleVersion
	){
		var version = OSGiUtil.toVersion( arguments.bundleVersion );
	...
	public boolean function isBundle( required string filePath ){
		...
		var bundleInfo = createObject(
			"java",
			"lucee.runtime.osgi.BundleInfo"
		).init( file );
